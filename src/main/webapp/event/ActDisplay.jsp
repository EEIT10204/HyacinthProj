...
<!-- -------------------------------------------------------------------------------------------- -->
        <div class="event_box">
            <img style=" padding-bottom: 30px;" src="data:image/png;base64,${event.actPhotoToBase64}" name="actPhoto" id="actPhoto" alt="event">
<!-- -------------------------------------------------------------------------------------------- --> 
...
<div class="collapse" id="collapseExample">
  <div class="card card-body" style="padding-right: 5rem";>
    ...
    <div id = "allButton"style="background-color: #f5f5f5; margin:auto; text-align: center; margin-right: ">
		<button type="button" id="LikeOrDisLike"class="btn btn-primary"  value="${likebottuntype}">${likebottuntype}</button>
		<button type="button" class="btn btn-success" id="AttendOrNot"  value="${attendbottuntype}">${attendbottuntype}</button>
...
<%-- 		<input type="hidden" id= "num" value="${user.actSNum}"> --%>
<%-- 		<input type="hidden" id= "mem" value="${user.id}"> --%>
		
<%-- 	!!!!!!!!!!!!${user.actSNum}!!!!!!!!${user.id}!!!!!!!!! --%>
...
// 	 alert(document.getElementById("actSNum").value);
// 	 alert(this.value);
	 if(this.value == 'Like'){
		 var process = true;
