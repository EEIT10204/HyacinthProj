...
<%-- 	<script src="${pageContext.request.contextPath}/js/bootstrap.min.js"></script> --%>
	 ...
	 <script src="${pageContext.request.contextPath}/js/blogUpdate.js"></script>
<style>
...
.updatebuttons:hover {background-color: #00916b}
            ...
            <div id="" class="comment">
                ...
                <div class="XXXXX">
                    ...
                    <form action="<c:url value="/Blog/BlogMember.comment"/>" method="get">
                      ...
                      margin-top:15px;margin-left: 620px; margin-bottom: 20px; id="sendbuttom";/">Send out</button>
                        </div>
                        </form>
                    ...
                    <div class="comment00">
                        <div>
                            <div class="comment01">
                                <a href="#">
                                    <img class="comment011" src="data:image/png;base64,${obj[1].memberPicToBase64}" alt="member">
                                </a>
                            </div>
                            <div class="divblog229">
                                <div class="comment000">
                                <div class="divblog2209">
                                    <a class="divblog22009" href="#">${obj[1].memberName}</a>
                                </div>
<!--                                 <div class="divblog2239"> -->
<!--                                         <button type="button" class="btn btn-outline-info divblog2201">檢舉</button> -->
<!--                                 </div> -->
                            </div>
                                <div class="divblog239" style="width:500px;">
                          ...
                          <input class="updatebuttons" type="hidden" value="送出" style="width:70px;height:25px" >           
<!--                         <input  type="submit" name="testupdate" value="送出" style="width:40px;height:27px;"> -->
                                </div>
